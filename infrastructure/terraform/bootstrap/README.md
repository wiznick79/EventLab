...
- separate federated credentials for the reviewer-protected `azure` environment and unattended `azure-cleanup`, using GitHub's exact environment-scoped OIDC subject format;
